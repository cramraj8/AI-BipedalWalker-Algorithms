...
class Agent(nn.Module):
    ...
    def __init__(self, state_size, action_size, random_seed, freeze_actor, pretrained_actor=None):
        ...
        self.actor_local = Actor(state_size, action_size, random_seed, freeze=freeze_actor, pretrained_actor=pretrained_actor).to(device)
        self.actor_target = Actor(state_size, action_size, random_seed, freeze=freeze_actor, pretrained_actor=pretrained_actor).to(device)
    ...
    def learn(self, experiences, gamma):
        ...
        torch.nn.utils.clip_grad_norm_(self.critic_target.parameters(), 1)
