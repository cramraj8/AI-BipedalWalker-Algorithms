...
class Policy():
    ...
    def is_dir_overflowing(self):
        num_files = len(os.listdir(self.hp.weights_dir))
        if num_files > self.hp.max_savedfiles:
            return True
        else:
            return False
...
class ARSTrainer():
    def __init__(self,
        ...
        self.hp.weights_dir = weights_dir
...
if __name__ == '__main__':
    ...
    videos_dir = mkdir('.', 'videos-train')
    monitor_dir = mkdir(videos_dir, ENV_NAME)
    WEIGHTS_DIR = mkdir(WEIGHTS_DIR, ENV_NAME)
